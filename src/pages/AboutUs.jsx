        ...
        <div>
          <div className="max-w-2xl mx-auto">
            ...
            <div className="collapse collapse-arrow bg-base-100 shadow-md mt-2">
              ...
              <div className="collapse-content">
                <p>
                  Buyers or businesses can post tasks that need to be completed.
                  They set the task requirements, payout, and deadline for
                  completion.
                </p>
              </div>
            </div>
            ...
            <div className="collapse collapse-arrow bg-base-100 shadow-md mt-2">
              ...
              <div className="collapse-content">
                <p>
                  Simply sign up for a free account, browse available tasks, and
                  start earning by completing tasks that match your skills and
                  interests.
                </p>
              </div>
            </div>
